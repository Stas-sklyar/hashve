...
const template = fs.readFileSync(path.join(__dirname, '.', 'dist/hashve-front', 'index.html')).toString();
// for mock global window by domino
const win = domino.createWindow(template);
// from server build
const files = fs.readdirSync(`${process.cwd()}/dist/hashve-front-server`);
// mock
global['window'] = win;
...
const { AppServerModuleNgFactory, LAZY_MODULE_MAP } = require(`./dist/hashve-front-server/main.${hash}`);
